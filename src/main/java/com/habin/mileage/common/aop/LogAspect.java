package com.habin.mileage.common.aop;
...
public class LogAspect {
    ...
    @Pointcut("within(com.habin.mileage.*.repository..*)")
    public void jpaQuery() {
    }

    @Pointcut("within(com.habin.mileage.*.module..*)")
    public void module() {
    }

    @Pointcut("within(com.habin.mileage.*.module.json..*)")
    ...
    @Around("@annotation(com.habin.mileage.common.aop.LogExecutionTime) || restApi() || jpaQuery() || module() && !jsonModule()")
