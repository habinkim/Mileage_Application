...
public class QMileageEventRepositoryImpl implements QMileageEventRepository {
    ...
    public SerializablePage<MileageListResponseDto> listWithPaging(String memberNo, MileageStatus mileageStatus, PageRequest pageRequest) {
        Predicate predicate = PredicateTemplate.builder()
    ...
    @Override
    public ConcurrentLinkedQueue<MileageListResponseDto> queue(String memberNo, MileageStatus mileageStatus) {
        List<MileageListResponseDto> fetch = queryFactory.select(
                        fields(MileageListResponseDto.class,
                                mileageEvent.mileageEventId,
                                mileageEvent.mileageStatus,
