package com.habin.marketboro_mileage_task.module.aop;
...
public class LogAspect {
    ...
    @Around("@annotation(com.habin.marketboro_mileage_task.module.aop.LogExecutionTime) || restApi() || jpaQuery() || module() && !jsonModule()")
