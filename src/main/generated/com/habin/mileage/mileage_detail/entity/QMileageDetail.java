package com.habin.mileage.mileage_detail.entity;
...
public class QMileageDetail extends EntityPathBase<MileageDetail> {
    ...
    private static final long serialVersionUID = 1207076743L;
    ...
    public final com.habin.mileage.mileage_event.entity.QMileageEvent mileageEvent;
    ...
    public QMileageDetail(Class<? extends MileageDetail> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mileageEvent = inits.isInitialized("mileageEvent") ? new com.habin.mileage.mileage_event.entity.QMileageEvent(forProperty("mileageEvent"), inits.get("mileageEvent")) : null;
    }
